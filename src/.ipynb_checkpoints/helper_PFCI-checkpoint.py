...
class PFHamiltonianGenerator:
    ...
    def fast_build_pcqed_cs_hamiltonian(
        ...
        """
        self.PCQED_H_CS = np.zeros((n_el * n_ph, n_el * n_ph))
        ...
        for n in range(n_ph):
            ...
            f_idx = (n + 1) * n_el
            # diagonal entries
            self.PCQED_H_CS[b_idx:f_idx, b_idx:f_idx] = _A + n * _O + _D
            ...
            if n == 0:
                ...
                self.PCQED_H_CS[bra_s:bra_e, ket_s:ket_e] = (
        ...
        eigs, vecs = np.linalg.eigh(self.PCQED_H_CS)
